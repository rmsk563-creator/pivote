...
"$CH" --headless=new --disable-gpu $EXTRA --window-size=1280,900 --virtual-time-budget=240000 --dump-dom "http://127.0.0.1:8123/_qa/pruebas.html" 2>/dev/null > /tmp/pv-pruebas.html
python3 - <<'PY'
import re, html
