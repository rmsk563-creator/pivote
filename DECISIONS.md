...
Quedan en comparación 3 variantes (V1 Piedra, V2 Fachada, V3 Latón). **Estado: dirección aprobada, variante pendiente.**

## D-008 · 2026-09-24 · Tipografía de exploración: Archivo + IBM Plex Mono
Archivo para títulos y cuerpo, IBM Plex Mono para cotas y anotaciones. Se mantuvo fija en las 3 variantes para comparar solo el color. **Estado: propuesta, se confirma en el Brand Gate.**
